# -*- coding: utf-8 -*-
"""test_render.py — Nghiệm thu render markdown + mindmap SVG (thuần code, 0 token).
Chạy: python3 test_render.py — KHÔNG gọi API, KHÔNG cần key.
"""
import csv
import io
import sys
...
# --- 1. mindmap SVG (thuần code, 0 token — không nhờ AI vẽ nên không lỗi cú pháp) ---
...
# --- 2. markdown ---
md = render(LO, images=[{"file": "ls-bai-1_mindmap.svg", "caption": "Sơ đồ tư duy"}])
...
check("ảnh mindmap tham chiếu filename trần", "![Sơ đồ tư duy](ls-bai-1_mindmap.svg)" in md)
